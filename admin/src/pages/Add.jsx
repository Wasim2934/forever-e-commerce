  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-125 px-3 py-2' type="text" placeholder='Write contect here' required />
      </div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-30' type="number" placeholder='25' />
        </div>
      </div>
          ...
          {sizeOptions.map((size) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1 cursor-pointer ${selected ? 'bg-pink-100 text-pink-700' : 'bg-slate-200 text-slate-700'}`}
              >
                {size}
              </button>
            )
